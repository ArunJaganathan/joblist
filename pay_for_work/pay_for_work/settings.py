"""
Django settings for pay_for_work project.
...
SECRET_KEY = 'django-insecure-s#r-$%v-v&@^-hu$w#f5jj_xqpl80^ks#*-i!$n=ul+y(7$xlg'
...
ROOT_URLCONF = 'pay_for_work.urls'
...
WSGI_APPLICATION = 'pay_for_work.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "jazzmin/img/logo-text.svg",
    #env\Lib\site-packages\jazzmin\static\jazzmin\img
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "social_apps/socialplugin/", "new_window": False},
    ...
    "usermenu_links": [
        {"name": "Support", "url": "social_apps/socialplugin/", "new_window": True},
        {"model": "auth.user"}
    ],
